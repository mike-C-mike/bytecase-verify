...
def save_manifest_xlsx(manifest, xlsx_path):
    ...
    add_title(ws_summary, "Hash Manifest Summary", columns=2)
...
def save_verification_xlsx(report, xlsx_path):
    ...
    add_title(ws_summary, "Hash Manifest Verification Summary", columns=2)
...
def save_compare_xlsx(report, xlsx_path):
    ...
    add_title(ws_summary, "Hash Manifest Compare Summary", columns=2)
